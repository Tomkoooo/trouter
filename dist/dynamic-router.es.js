...
function Ee(e, t, n, r) {
  ...
  let a = (o, i, l) => {
    ...
    let u = S([r, s.relativePath]), f = n.concat(s);
...
function He(e, t, n) {
  ...
  for (let l = 0; l < r.length; ++l) {
    ...
    Object.assign(a, d.params), i.push({
      ...
      pathnameBase: et(S([o, d.pathnameBase])),
      route: h
...
const S = (e) => e.join("/").replace(/\/\/+/g, "/"), et = (e) => e.replace(/\/+$/, "").replace(/^\/*/, "/"), tt = (e) => !e || e === "?" ? "" : e.startsWith("?") ? e : "?" + e, nt = (e) => !e || e === "#" ? "" : e.startsWith("#") ? e : "#" + e;
function rt(e) {
...
const P = /* @__PURE__ */ c.createContext({
  outlet: null,
  matches: [],
  isDataRoute: !1
});
...
function it(e, t) {
  ...
  return r !== "/" && (s = i === "/" ? r : S([r, i])), a.createHref({
    pathname: s,
    search: l,
    hash: o
  });
...
function lt() {
  ...
  return Re(() => {
    ...
    e == null && t !== "/" && (d.pathname = d.pathname === "/" ? t : S([t, d.pathname])), (f.replace ? r.replace : r.push)(d, f.state, f);
  }, [t, r, i, o, e]);
}
function $(e, t) {
  let {
...
function ut(e, t, n, r) {
  ...
  let {
    ...
    matches: o
  } = c.useContext(P), i = o[o.length - 1], l = i ? i.params : {}, s = i ? i.pathname : "/", u = i ? i.pathnameBase : "/", f = i && i.route;
...
` + ('Please change the parent <Route path="' + p + '"> to <Route ') + ('path="' + (p === "/" ? "*" : p + "/*") + '">.'));
  ...
  let N = ht(m && m.map((p) => Object.assign({}, p, {
    ...
    pathnameBase: p.pathnameBase === "/" ? u : S([
      u,
      // Re-encode pathnames that were decoded inside matchRoutes
...
function ct() {
  let e = yt(), t = rt(e) ? e.status + " " + e.statusText : e instanceof Error ? e.message : JSON.stringify(e), n = e instanceof Error ? e.stack : null, r = "rgba(200,200,200, 0.5)", a = {
    padding: "0.5rem",
    backgroundColor: r
  }, o = {
    padding: "2px 4px",
...
const dt = /* @__PURE__ */ c.createElement(ct, null);
class ft extends c.Component {
  constructor(t) {
    super(t), this.state = {
      location: t.location,
  ...
  render() {
    return this.state.error !== void 0 ? /* @__PURE__ */ c.createElement(P.Provider, {
...
function pt(e) {
  ...
  return a && a.static && a.staticContext && (n.route.errorElement || n.route.ErrorBoundary) && (a.staticContext._deepestRenderedBoundaryId = n.route.id), /* @__PURE__ */ c.createElement(P.Provider, {
    value: t
  }, r);
}
function ht(e, t, n, r) {
  ...
  return i.reduceRight((f, d, h) => {
    ...
    n && (x = l && d.route.id ? l[d.route.id] : void 0, g = d.route.errorElement || dt, s && (u < 0 && h === 0 ? (Se("route-fallback", !1, "No `HydrateFallback` element provided to render during initial hydration"), y = !0, m = null) : u === h && (y = !0, m = d.route.hydrateFallbackElement || null)));
    let N = t.concat(i.slice(0, h + 1)), p = () => {
      let E;
      return x ? E = g : y ? E = m : d.route.Component ? E = /* @__PURE__ */ c.createElement(d.route.Component, null) : d.route.element ? E = d.route.element : E = f, /* @__PURE__ */ c.createElement(pt, {
        match: d,
        routeContext: {
          outlet: f,
          matches: N,
    ...
    return n && (d.route.ErrorBoundary || d.route.errorElement || h === 0) ? /* @__PURE__ */ c.createElement(ft, {
      location: n.location,
...
function ie(e) {
  let t = gt(e), n = t.matches[t.matches.length - 1];
...
function yt() {
  var e;
  let t = c.useContext(re), n = vt(I.UseRouteError), r = ie(I.UseRouteError);
  return t !== void 0 ? t : (e = n.errors) == null ? void 0 : e[r];
}
function Nt() {
  let {
    router: e
  } = mt(Ce.UseNavigateStable), t = ie(I.UseNavigateStable), n = c.useRef(!1);
  return Re(() => {
    n.current = !0;
...
const me = (e, t, n) => wt(e, "⚠️ React Router Future Flag Warning: " + t + ". " + ("You can use the `" + e + "` future flag to opt-in early. ") + ("For more information, see " + n + "."));
function xt(e, t) {
...
function Q(e) {
  return e != null && !Lt.has(e) ? (process.env.NODE_ENV !== "production" && C(!1, '"' + e + '" is not a valid `encType` for `<Form>`/`<fetcher.Form>` ' + ('and will default to "' + z + '"')), null) : e;
}
function Tt(e, t) {
  let n, r, a, o, i;
  if (St(e)) {
  ...
  } else if (Ct(e) || Pt(e) && (e.type === "submit" || e.type === "image")) {
    let l = e.form;
    if (l == null)
      throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
    let s = e.getAttribute("formaction") || l.getAttribute("action");
    if (r = s ? _(s, t) : null, n = e.getAttribute("formmethod") || l.getAttribute("method") || j, a = Q(e.getAttribute("formenctype")) || Q(l.getAttribute("enctype")) || z, o = new FormData(l, e), !_t()) {
      let {
        name: u,
        type: f,
        value: d
...
const Vt = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "viewTransition"], Ut = ["aria-current", "caseSensitive", "className", "end", "style", "to", "viewTransition", "children"], Ft = ["fetcherKey", "navigate", "reloadDocument", "replace", "state", "method", "action", "onSubmit", "relative", "preventScrollReset", "viewTransition"], kt = "6";
try {
  window.__reactRouterVersion = kt;
} catch {
}
...
const It = /* @__PURE__ */ c.createContext(/* @__PURE__ */ new Map());
process.env.NODE_ENV !== "production" && (It.displayName = "Fetchers");
const Bt = "startTransition", ve = c[Bt];
function Wt(e) {
  let {
    basename: t,
    children: n,
  ...
  return c.useLayoutEffect(() => i.listen(f), [i, f]), c.useEffect(() => xt(r), [r]), /* @__PURE__ */ c.createElement(bt, {
    basename: t,
    children: n,
    location: l.location,
...
const At = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", $t = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, Oe = /* @__PURE__ */ c.forwardRef(function(t, n) {
  let {
    onClick: r,
    relative: a,
    reloadDocument: o,
  ...
  if (typeof u == "string" && $t.test(u) && (y = u, At))
    try {
...
const Mt = /* @__PURE__ */ c.forwardRef(function(t, n) {
  let {
    "aria-current": r = "page",
    caseSensitive: a = !1,
    className: o = "",
  ...
  Xt(h) && u === !0, p = g.encodeLocation ? g.encodeLocation(h).pathname : h.pathname, E = x.pathname, w = y && y.navigation && y.navigation.location ? y.navigation.location.pathname : null;
...
process.env.NODE_ENV !== "production" && (Mt.displayName = "NavLink");
const jt = /* @__PURE__ */ c.forwardRef((e, t) => {
  let {
    fetcherKey: n,
    navigate: r,
    reloadDocument: a,
...
process.env.NODE_ENV !== "production" && (jt.displayName = "Form");
process.env.NODE_ENV;
var J;
(function(e) {
...
function De(e) {
  let t = c.useContext(B);
  return t || (process.env.NODE_ENV !== "production" ? v(!1, zt(e)) : v(!1)), t;
}
function Kt(e, t) {
  let {
    target: n,
...
function Gt(e, t) {
  let {
    ...
    basename: r
  } = c.useContext(R), a = c.useContext(P);
  ...
  return (!e || e === ".") && o.route.index && (i.search = i.search ? i.search.replace(/^\?/, "?index&") : "?index"), r !== "/" && (i.pathname = i.pathname === "/" ? r : S([r, i.pathname])), F(i);
}
function Xt(e, t) {
  t === void 0 && (t = {});
...
const Qt = ({ to: e, children: t, className: n, target: r }) => {
  const a = ae(), o = (i) => {
  ...
  const a = /* @__PURE__ */ Object.assign({}), o = (l) => {
  ...
  return /* @__PURE__ */ b.createElement(Wt, null, /* @__PURE__ */ b.createElement(Ve, { fallback: e }, /* @__PURE__ */ b.createElement(Rt, null, i.map(({ path: l, component: s }) => {
    const u = r || en;
  ...
  }), /* @__PURE__ */ b.createElement(ee, { path: "*", element: /* @__PURE__ */ b.createElement(Zt, null) }))));
};
export {
  rn as DynamicRouter,
  Qt as Link,
